...
export async function sendReviewEmail(email: string, name: string, orderId: string) {
  await resend.emails.send({
    from: 'OBRYS <no-reply@updates.obrys.info>',
    to: email,
    subject: "Su pedido está listo para revisión",
    html: getReviewEmailTemplate(name, orderId),
  });
}

function getReviewEmailTemplate(name: string, orderId: string) {
  return `
                  ...
                  <td>
                    <div
                      ...
                      <p style="margin:0;padding:0">
                        Su pedido está listo para revisión.
                      </p>
                    </div>
                    <table
                      width="100%"
                                            ...
                                            <p style="margin:0;padding:0">
                                              <span style="color:#2b2e1f"
                                                ><span
                                                  ...
                                                  >✓ Pedido listo para revisión</span
                                                ></span
                                              >
                                            </p>
                                          </td>
                                ...
                                <tr style="margin:0;padding:0">
                                  <td
                                    ...
                                    <p style="margin:0 0 16px 0;padding:0;font-family:Georgia, serif;font-size:17px;line-height:1.6;color:#3d4231">
                                      Nos complace informarle que el trabajo de su pedido ha sido completado y los archivos están listos para su revisión.
                                    </p>

                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" class="btn">
                                      <tr>
                                        <td bgcolor="#7a8466" style="border-radius:2px;">
                                          <a href="${process.env.NEXT_PUBLIC_SITE_URL}/es/dashboard/orders/${orderId}" style="display:inline-block; padding:16px 32px; font-family: Georgia, serif; font-size:15px; color:#f5efe0; text-decoration:none; letter-spacing:0.5px;">
                                            Ver los resultados &nbsp;→
                                          </a>
                                        </td>
                                      </tr>
                                    ...
                                    <p style="margin:24px 0 24px 0;padding:0;font-family:Georgia, serif;font-size:17px;line-height:1.6;color:#3d4231">
                                      Por favor, acceda a su portal para revisar el trabajo. Si todo es correcto, puede aprobar el trabajo directamente en la plataforma.
                                    </p>
                                    <p style="margin:0 0 24px 0;padding:0;font-family:Georgia, serif;font-size:17px;line-height:1.6;color:#3d4231">
                                      Si tiene alguna duda o comentario, puede utilizar la sección de mensajes en el mismo pedido.
                                    </p>
                                  </td>
                                </tr>
                                <tr style="margin:0;padding:0">
